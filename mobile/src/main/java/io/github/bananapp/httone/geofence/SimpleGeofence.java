...
public class SimpleGeofence {
     ...
     */
    public SimpleGeofence(String geofenceId, String name, double latitude, double longitude,
    ...
    public static SimpleGeofence newGeofence(final Place place) {

        return new SimpleGeofence(place.getId(), place.getName(), place.getLat(), place.getLong(),
                                  (float) place.getRadius(), Long.MAX_VALUE,
